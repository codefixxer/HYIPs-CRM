...
<body style="background-color: rgb(29, 30, 36) !important;">
			...
			<nav class="uk-navbar-container uk-navbar-transparent" data-uk-sticky="show-on-up: true; animation: uk-animation-slide-top;">
				<div class="uk-container" data-uk-navbar>
					<div class="uk-navbar-left">
						<a class="uk-navbar-item uk-logo" href="{{ route('welcome') }}">
							<img src="{{ asset('asset/img/user/header-logo-Uw3Zp9.svg') }}" alt="logo" width="146" height="40">
						</a>
						<ul class="uk-navbar-nav uk-visible@m">
							<li><a href="{{ route('welcome') }}">Home<span data-uk-navbar-parent-icon></span></a>
					...
					<div class="uk-navbar-right">
						<div class="uk-navbar-item uk-visible@m in-optional-nav">
							...
							<a href="{{ route('registerform') }}" class="uk-button uk-button-primary">Sign up<i class="fas fa-arrow-circle-right uk-margin-small-left"></i></a>
						</div>
					</div>
				</div>
			</nav>
	...
	<main>
		...
		<div class="uk-section uk-padding-remove-vertical in-slideshow-gradient">
			<div id="particles-js" class="uk-light in-slideshow uk-background-contain" data-src="{{ asset('asset/img/in-equity-decor-1.svg') }}" data-uk-img data-uk-slideshow>
				<hr>
						...
						<div class="uk-container">
							<div class="uk-grid-large uk-flex-middle" data-uk-grid>
								<div class="uk-width-1-2@s in-slide-text">
									...
									<div class="uk-grid-medium uk-child-width-1-3@m uk-child-width-1-2@s uk-margin-medium-top uk-visible@s" data-uk-grid>
										<div>
											<div class="uk-card uk-card-small uk-card-secondary uk-card-body uk-border-rounded uk-flex uk-flex-middle">
												<div class="in-symbol-logo">
													<img src="{{ asset('asset/img/in-lazy.gif') }}" data-src="{{ asset('asset/img/in-symbol-tesla.svg') }}" alt="ticker" width="28" height="28" data-uk-img>
												</div>
										...
										<div>
											<div class="uk-card uk-card-small uk-card-secondary uk-card-body uk-border-rounded uk-flex uk-flex-middle">
												<div class="in-symbol-logo">
													<img src="{{ asset('asset/img/in-lazy.gif') }}" data-src="{{ asset('asset/img/in-symbol-google.svg') }}" alt="ticker" width="28" height="28" data-uk-img>
												</div>
										...
										<div class="uk-visible@m">
											<div class="uk-card uk-card-small uk-card-secondary uk-card-body uk-border-rounded uk-flex uk-flex-middle">
												<div class="in-symbol-logo">
													<img src="{{ asset('asset/img/in-lazy.gif') }}" data-src="{{ asset('asset/img/in-symbol-apple.svg') }}" alt="ticker" width="28" height="28" data-uk-img>
												</div>
												<div class="in-price up">
								...
								<div class="in-slide-img">
									<img src="{{ asset('asset/img/in-lazy.gif') }}" data-src="{{ asset('asset/img/in-equity-slide-1.png') }}" alt="image-slide" width="652" height="746" data-uk-img>
								</div>
							</div>
						</div>
					</li>
					<li class="uk-flex uk-flex-middle">
						<div class="uk-container">
							<div class="uk-grid-large uk-flex-middle" data-uk-grid>
								<div class="uk-width-1-2@s in-slide-text">
									...
									<div class="uk-grid-medium uk-child-width-1-3@m uk-child-width-1-2@s uk-margin-medium-top uk-visible@s" data-uk-grid>
										<div>
											<div class="uk-card uk-card-small uk-card-secondary uk-card-body uk-border-rounded uk-flex uk-flex-middle">
												<div class="in-symbol-logo">
													<img src="{{ asset('asset/img/in-lazy.gif') }}" data-src="{{ asset('asset/img/in-symbol-mcdonalds.svg') }}" alt="ticker" width="28" height="28" data-uk-img>
												</div>
												<div class="in-price down">
										...
										<div>
											<div class="uk-card uk-card-small uk-card-secondary uk-card-body uk-border-rounded uk-flex uk-flex-middle">
												<div class="in-symbol-logo">
													<img src="{{ asset('asset/img/in-lazy.gif') }}" data-src="{{ asset('asset/img/in-symbol-amazon.svg') }}" alt="ticker" width="28" height="28" data-uk-img>
												</div>
												<div class="in-price up">
										...
										<div class="uk-visible@m">
											<div class="uk-card uk-card-small uk-card-secondary uk-card-body uk-border-rounded uk-flex uk-flex-middle">
												<div class="in-symbol-logo">
													<img src="{{ asset('asset/img/in-lazy.gif') }}" data-src="{{ asset('asset/img/in-symbol-microsoft.svg') }}" alt="ticker" width="28" height="28" data-uk-img>
												</div>
												<div class="in-price down">
								...
								<div class="in-slide-img">
									<img src="{{ asset('asset/img/in-lazy.gif') }}" data-src="{{ asset('asset/img/in-equity-slide-2.png') }}" alt="image-slide" width="652" height="746" data-uk-img>
								</div>
							</div>
						</div>
					</li>
						...
						<div class="uk-grid-collapse uk-child-width-1-2@m in-equity-pricing" data-uk-grid>
							<div>
								<div class="uk-card uk-card-default uk-card-body uk-box-shadow-medium">
									...
									<a href="{{ route('registerform') }}" class="uk-button uk-button-default uk-border-rounded uk-align-center">Open an account<i class="fas fa-arrow-circle-right uk-margin-small-left"></i></a>
								</div>
							</div>
							<div>
								<div class="uk-card uk-card-default uk-card-body uk-box-shadow-large">
									...
									<a href="{{ route('registerform') }}" class="uk-button uk-button-primary uk-border-rounded uk-align-center">Open an account<i class="fas fa-arrow-circle-right uk-margin-small-left"></i></a>
								</div>
							</div>
						</div>
					</div>
		...
		<!-- section content end -->
		<!-- section content begin -->
		<div class="uk-section in-equity-2 uk-background-contain uk-background-center" data-src="{{ asset('asset/img/in-equity-2-bg.png') }}" data-uk-img>
			<div class="uk-container uk-margin-top">
				<div class="uk-grid uk-flex uk-flex-center">
					...
					<div class="uk-width-3-4@m uk-margin-medium-top">
						<img class="uk-align-center" src="{{ asset('asset/img/in-lazy.gif') }}" data-src="{{ asset('asset/img/in-equity-2-img.png') }}" alt="image" width="758" height="334" data-uk-img>
					</div>
						...
						<div class="uk-grid uk-child-width-1-4@m uk-child-width-1-4@s uk-text-center in-feature-box" data-uk-grid>
							<a href="#">
								<span class="in-icon-wrap">
									<img src="{{ asset('asset/img/in-lazy.gif') }}" data-src="{{ asset('asset/img/in-equity-2-icon-1.svg') }}" alt="icon-1" width="35" height="42" data-uk-img>
								</span>
								<p class="uk-margin-top">Trading calculators</p>
							</a>
							<a href="#">
								<span class="in-icon-wrap">
									<img src="{{ asset('asset/img/in-lazy.gif') }}" data-src="{{ asset('asset/img/in-equity-2-icon-2.svg') }}" alt="icon-2" width="38" height="42" data-uk-img>
								</span>
								<p class="uk-margin-top">Market analysis</p>
							</a>
							<a href="#">
								<span class="in-icon-wrap">
									<img src="{{ asset('asset/img/in-lazy.gif') }}" data-src="{{ asset('asset/img/in-equity-2-icon-3.svg') }}" alt="icon-3" width="42" height="42" data-uk-img>
								</span>
								<p class="uk-margin-top">Market reviews</p>
							</a>
							<a href="#">
								<span class="in-icon-wrap">
									<img src="{{ asset('asset/img/in-lazy.gif') }}" data-src="{{ asset('asset/img/in-equity-2-icon-4.svg') }}" alt="icon-4" width="42" height="42" data-uk-img>
								</span>
		...
		<div class="uk-section in-equity-4">
			<div class="uk-container uk-margin-top uk-margin-medium-bottom">
				<div class="uk-grid uk-child-width-1-2@m in-testimonial-2" data-uk-grid>
					...
					<div>
						<div class="uk-background-contain uk-background-top-left" data-src="{{ asset('asset/img/in-equity-4-blob-1.svg') }}" data-uk-img>
							<div class="uk-flex uk-flex-middle">
								<div class="uk-margin-right">
									<div class="uk-background-primary uk-border-pill">
										<img class="uk-align-center uk-border-pill" src="{{ asset('asset/img/in-lazy.gif') }}" data-src="{{ asset('asset/img/blockit/in-team-1.png') }}" alt="client-1" width="100" height="100" data-uk-img>
									</div>
								</div>
								<div>
					...
					<div>
						<div class="uk-background-contain uk-background-top-left" data-src="{{ asset('asset/img/in-equity-4-blob-2.svg') }}" data-uk-img>
							<div class="uk-flex uk-flex-middle">
								<div class="uk-margin-right">
									<div class="uk-background-primary uk-border-pill">
										<img class="uk-align-center uk-border-pill" src="{{ asset('asset/img/in-lazy.gif') }}" data-src="{{ asset('asset/img/blockit/in-team-8.png') }}" alt="client-2" width="100" height="100" data-uk-img>
									</div>
								</div>
								<div>
			...
			<div class="uk-container uk-margin-remove-bottom">
				<div class="uk-grid uk-child-width-1-3@m uk-child-width-1-2@s" data-uk-grid>
					<div>
						<div class="uk-flex uk-flex-left in-award">
							<div class="uk-margin-small-right">
								<img src="{{ asset('asset/img/in-lazy.gif') }}" data-src="{{ asset('asset/img/in-equity-5-award-1.svg') }}" alt="award-1" width="91" height="82" data-uk-img>
							</div>
							<div>
					...
					<div>
						<div class="uk-flex uk-flex-left in-award">
							<div class="uk-margin-small-right">
								<img src="{{ asset('asset/img/in-lazy.gif') }}" data-src="{{ asset('asset/img/in-equity-5-award-2.svg') }}" alt="award-2" width="91" height="82" data-uk-img>
							</div>
							<div>
					...
					<div class="uk-visible@m">
						<div class="uk-flex uk-flex-left in-award">
							<div class="uk-margin-small-right">
								<img src="{{ asset('asset/img/in-lazy.gif') }}" data-src="{{ asset('asset/img/in-equity-5-award-3.svg') }}" alt="award-3" width="91" height="82" data-uk-img>
							</div>
							<div>
		...
		<!-- section content end -->
		<!-- section content begin -->
		<div class="uk-section uk-section-primary uk-preserve-color in-equity-6 uk-background-contain uk-background-center" data-src="{{ asset('asset/img/in-equity-decor-2.svg') }}" data-uk-img>
				...
				<div class="uk-grid uk-flex uk-flex-center">
					...
					<div class="uk-width-3-4@m uk-margin-medium-top">
						<div class="uk-flex uk-flex-center uk-flex-middle button-app">
							...
							<div class="uk-margin-right">
								<a href="#"><img src="{{ asset('asset/img/in-lazy.gif') }}" data-src="{{ asset('asset/img/in-app-store.svg') }}" alt="app-store" width="120" height="40" data-uk-img></a>
							</div>
							<div>
								<a href="#"><img src="{{ asset('asset/img/in-lazy.gif') }}" data-src="{{ asset('asset/img/in-google-play.svg') }}" alt="google-play" width="135" height="40" data-uk-img></a>
							</div>
						</div>
					</div>
				</div>
			...
			<div class="uk-container">
				<div class="uk-grid uk-flex uk-flex-middle">
					...
					<div class="uk-width-1-3@m uk-flex uk-flex-right uk-visible@m">
						<span class="uk-margin-right"><img src="{{ asset('asset/img/in-lazy.gif') }}" data-src="{{ asset('asset/img/in-footer-mastercard.svg') }}" alt="footer-payment" width="34" height="21" data-uk-img=""></span>
						<span><img src="{{ asset('asset/img/in-lazy.gif') }}" data-src="{{ asset('asset/img/in-footer-visa.svg') }}" alt="footer-payment" width="50" height="16" data-uk-img=""></span>
					</div>
				</div>
			</div>
		</div>
