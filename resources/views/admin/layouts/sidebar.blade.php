        ...
        <div class="item-wrapper mb-5">
            ...
            <ul class="mt-2.5">
                    ...
                    <a href="index.html">
                        <div class="flex items-center justify-between">
                            <div class="flex items-center space-x-2.5">
                                ...
                                <span
                                    class="item-text text-lg font-medium leading-none">Packages</span>
                            </div>
                            <span>
                    ...
                    <ul class="sub-menu ml-2.5 mt-[22px] border-l border-success-100 pl-5">
                        <li>
                            <a href="{{ route('admin.packages.create') }}"
                                class="text-md inline-block py-1.5 font-medium text-bgray-600 transition-all hover:text-bgray-800 dark:text-bgray-50 hover:dark:text-success-300">Create
                                </a>
                        </li>
                        <li>
                            <a href="{{ route('admin.packages.index') }}"
                                class="text-md inline-block py-1.5 font-medium text-bgray-600 transition-all hover:text-bgray-800 dark:text-bgray-50 hover:dark:text-success-300">List
                                </a>
                        </li>
                    ...
                    <a href="index.html">
                        <div class="flex items-center justify-between">
                            <div class="flex items-center space-x-2.5">
                                ...
                                <span
                                    class="item-text text-lg font-medium leading-none">Banks</span>
                            </div>
                            <span>
                                <svg width="6" height="12" viewBox="0 0 6 12" fill="none"
                                    class="fill-current" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <a href="index.html">
                        <div class="flex items-center justify-between">
                            <div class="flex items-center space-x-2.5">
                                ...
                                <span
                                    class="item-text text-lg font-medium leading-none">Transactions</span>
                            </div>
                            <span>
                                <svg width="6" height="12" viewBox="0 0 6 12" fill="none"
                                    class="fill-current" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <a href="index.html">
                        <div class="flex items-center justify-between">
                            <div class="flex items-center space-x-2.5">
                                ...
                                <span
                                    class="item-text text-lg font-medium leading-none">Withdrawals</span>
                            </div>
                            <span>
                                <svg width="6" height="12" viewBox="0 0 6 12" fill="none"
                                    class="fill-current" xmlns="http://www.w3.org/2000/svg">
                ...
                {{-- <li class="item py-[11px] text-bgray-900 dark:text-white">
                    <a href="index.html">
                        <div class="flex items-center justify-between">
                            <div class="flex items-center space-x-2.5">
                                ...
                                <span
                                    class="item-text text-lg font-medium leading-none">User Packages</span>
                            </div>
                            <span>
                                <svg width="6" height="12" viewBox="0 0 6 12" fill="none"
                                    class="fill-current" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <ul class="sub-menu ml-2.5 mt-[22px] border-l border-success-100 pl-5">
                        <li>
                            <a href="{{ route('admin.user_packages.create') }}"
                                class="text-md inline-block py-1.5 font-medium text-bgray-600 transition-all hover:text-bgray-800 dark:text-bgray-50 hover:dark:text-success-300">Create
                                </a>
                        </li>
                        <li>
                            <a href="{{ route('admin.user_packages.index') }}"
                                class="text-md inline-block py-1.5 font-medium text-bgray-600 transition-all hover:text-bgray-800 dark:text-bgray-50 hover:dark:text-success-300">List
                                </a>
                        </li>
