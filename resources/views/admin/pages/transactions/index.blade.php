...
<td class="px-6 py-5">
    <div class="flex justify-center space-x-4">
        <!-- Edit Button -->
        <a href="{{ route('admin.transactions.edit', $transaction->id) }}" class="text-blue-500 hover:text-blue-700 font-semibold px-4 py-2 rounded-lg border border-blue-500 hover:bg-blue-50 focus:outline-none focus:ring-2 focus:ring-blue-500 transition-all">Edit</a>
