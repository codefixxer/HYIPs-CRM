...
<head>
	...
	<title>Homepage 4 - Equity HTML5 Template</title>
</head>
...
<body>
	...
	<main>
		...
		<div class="uk-section uk-section-primary uk-preserve-color uk-background-contain uk-background-center in-equity-15" data-src="img/in-equity-15-bg.png" data-uk-img>
			<div class="uk-container uk-margin-top uk-margin-medium-bottom">
				<div class="uk-grid">
					<div class="uk-width-3-5@m">
						...
						<p class="uk-text-lead uk-margin-remove-top">Your funds are fully secured when you trade with Equity.</p>
						<div class="uk-grid-large uk-child-width-1-2@m uk-child-width-1-2@s uk-margin-medium-top uk-margin-medium-bottom" data-uk-grid>
							<div>
								<div class="uk-flex uk-flex-middle">
									<div class="uk-margin-right">
										<img src="img/in-lazy.gif" data-src="img/in-equity-15-icon-1.svg" alt="icon-1" width="96" height="96" data-uk-img>
									</div>
									<div>
										<p class="uk-margin-remove">Safe, reliable, transparent and credible</p>
									</div>
								</div>
							</div>
							<div>
								<div class="uk-flex uk-flex-middle">
									<div class="uk-margin-right">
										<img src="img/in-lazy.gif" data-src="img/in-equity-15-icon-2.svg" alt="icon-2" width="96" height="96" data-uk-img>
									</div>
									<div>
							...
							<div>
								<div class="uk-flex uk-flex-middle in-offset-top-20">
									<div class="uk-margin-right">
										<img src="img/in-lazy.gif" data-src="img/in-equity-15-icon-3.svg" alt="icon-3" width="96" height="96" data-uk-img>
									</div>
									<div>
							...
							<div>
								<div class="uk-flex uk-flex-middle in-offset-top-20">
									<div class="uk-margin-right">
										<img src="img/in-lazy.gif" data-src="img/in-equity-15-icon-4.svg" alt="icon-4" width="96" height="96" data-uk-img>
									</div>
									<div>
						...
						<div class="uk-flex uk-flex-left uk-flex-middle get-started">
							...
							<a href="#" class="uk-button uk-button-primary uk-border-rounded uk-margin-left">Open demo account<i class="fas fa-arrow-circle-right uk-margin-small-left"></i></a>
							<a href="#" class="uk-button uk-button-secondary uk-border-rounded uk-margin-left">Open live account<i class="fas fa-arrow-circle-right uk-margin-small-left"></i></a>
						</div>
					</div>
				</div>
		...
		<!-- section content end -->
		<!-- section content begin -->
		<div class="uk-section uk-padding-remove-vertical in-equity-18">
			<div class="uk-container">
				<div class="uk-grid" data-uk-grid>
					<div class="uk-width-1-1">
						<div class="uk-card uk-card-default uk-card-body uk-border-rounded">
							<h4 class="uk-text-center in-offset-top-10">Fast and reliable withdrawal/deposit method</h4>
							<div class="uk-grid-collapse uk-child-width-1-6@m uk-child-width-1-2@s uk-text-center in-client-logo-6" data-uk-grid>
								<div class="uk-tile uk-tile-default">
									<img class="uk-margin-remove" src="img/in-equity-payment-1.svg" alt="client-logo" width="167" height="55">
								</div>
								<div class="uk-tile uk-tile-default">
									<img class="uk-margin-remove" src="img/in-equity-payment-2.svg" alt="client-logo" width="167" height="55">
								</div>
								<div class="uk-tile uk-tile-default">
									<img class="uk-margin-remove" src="img/in-equity-payment-3.svg" alt="client-logo" width="167" height="55">
								</div>
								<div class="uk-tile uk-tile-default">
									<img class="uk-margin-remove" src="img/in-equity-payment-4.svg" alt="client-logo" width="167" height="55">
								</div>
								<div class="uk-tile uk-tile-default">
									<img class="uk-margin-remove" src="img/in-equity-payment-5.svg" alt="client-logo" width="167" height="55">
								</div>
								<div class="uk-tile uk-tile-default">
									<img class="uk-margin-remove" src="img/in-equity-payment-6.svg" alt="client-logo" width="167" height="55">
								</div>
							</div>
						</div>
					</div>
